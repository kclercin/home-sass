...
const QuoteOfTheDay: React.FC = () => {
  ...
  const quotes: Quote[] = [
    ...
    {
      date: "2025-09-19",
      citation: "En 2013, une Californienne a attendu devant une prison d'état afin de giflé un adjoint du sheriff, car elle voulait aller en prison pour pouvoir arrêter de fumer après s'etre dit que c'était le seul moyen car le tabac était interdit à l'intérieur, elle a écopée de 63 jours de prison."
    }
  ];
