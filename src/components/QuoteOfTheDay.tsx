...
const QuoteOfTheDay: React.FC = () => {
  ...
  const quotes: Quote[] = [
    ...
    {
      date: "2025-09-19",
      citation: "En 2013, une Californienne a attendu devant une prison d'état afin de gifler un adjoint du sheriff, son acte a été motivé par le fait de vouloir arrêter de fumer car le tabac étant interdit en prison, elle s'est dit que c'était le seul moyen, elle a écopée de 63 jours de prison."
    }
  ];
